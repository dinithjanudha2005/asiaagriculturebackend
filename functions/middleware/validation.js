...
const createOrderSchema = Joi.object({
  ...
  phoneNumber01: Joi.string()
    ...
    .messages({
      ...
      'string.pattern.base': 'Primary phone number must be a valid phone number'
    }),
  ...
  phoneNumber02: Joi.string()
    ...
    .allow("")
    .messages({
      'string.pattern.base': 'Secondary phone number must be a valid phone number'
    }),
